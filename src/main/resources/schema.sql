...
CREATE TYPE IF NOT EXISTS valid_event_type AS ENUM ('LIKE', 'REVIEW', 'FRIEND');

CREATE TYPE IF NOT EXISTS valid_operation_type AS ENUM ('REMOVE', 'ADD', 'UPDATE');

CREATE TABLE IF NOT EXISTS events (
event_id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
user_id bigint REFERENCES users (user_id) ON DELETE CASCADE,
event_type valid_event_type,
operation_type valid_operation_type,
time_stamp bigint,
entity_id bigint,
